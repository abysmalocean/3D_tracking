...
# TODO: build a db_sampler for tracking result
db_sampler = dict(
    type="GT-AUG", 
    enable=False, 
    db_info_path="data/nuScenes/dbinfos_train_10sweeps_withvelo.pkl",
    # ? why they group this sample? 
    sample_groups=[
        dict(car=2),
        dict(truck=3),
...
# TODO: Check the voxel generator! 
...
# TODO: dig into each functions, and check what really are! 
train_pipeline = [
